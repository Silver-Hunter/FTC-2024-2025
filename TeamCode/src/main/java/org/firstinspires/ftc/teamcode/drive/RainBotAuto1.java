 ...
 */
@Autonomous(name="Rain Bot Auto (PLAN A)", group="Robot")

public class RainBotAuto1 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        while (opModeIsActive()) {
            ...
            while (pos.x < WP2.x ) {
                ...
                telemetry.addData("Y coordinate", pos.y);
                telemetry.addData("Heading angle", pos.h);
                telemetry.addData("Target X coordinate", WP2.x);
                telemetry.addData("TargetY coordinate", WP2.y);
                telemetry.addData("Target Heading angle", WP2.h);
                telemetry.update();
                pos = myOtos.getPosition();
            }
            moveStop();
            ...
            while (pos.y < WP3.y ) {
                ...
                telemetry.addData("Y coordinate", pos.y);
                telemetry.addData("Heading angle", pos.h);
                telemetry.addData("Target X coordinate", WP3.x);
                telemetry.addData("TargetY coordinate", WP3.y);
                telemetry.addData("Target Heading angle", WP3.h);
                telemetry.update();
                pos = myOtos.getPosition();
            }
            moveStop();
            ...
            while (pos.y > WP4.y ) {
                ...
                telemetry.addData("Y coordinate", pos.y);
                telemetry.addData("Heading angle", pos.h);
                telemetry.addData("Target X coordinate", WP4.x);
                telemetry.addData("TargetY coordinate", WP4.y);
                telemetry.addData("Target Heading angle", WP4.h);
                telemetry.update();
                pos = myOtos.getPosition();
            }
            moveStop();
            ...
            while (pos.x > WP5.x ) {
                ...
                telemetry.addData("Y coordinate", pos.y);
                telemetry.addData("Heading angle", pos.h);
                telemetry.addData("Target X coordinate", WP5.x);
                telemetry.addData("TargetY coordinate", WP5.y);
                telemetry.addData("Target Heading angle", WP5.h);
                telemetry.update();
                pos = myOtos.getPosition();
            }
            moveStop();
    ...
    public void turnRight(double x, double yaw) {
    }
    ...
    private void configureOtos() {
        ...
        SparkFunOTOS.Pose2D offset = new SparkFunOTOS.Pose2D(-8, -2.5, 0);
