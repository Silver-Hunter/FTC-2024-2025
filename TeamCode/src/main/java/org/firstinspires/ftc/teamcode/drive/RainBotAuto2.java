 ...
 */
@Autonomous(name="Rain Bot Auto (PLAN B PARK)", group="Robot")

public class RainBotAuto2 extends LinearOpMode {
    ...
    public void runOpMode() {
        ...
        SparkFunOTOS.Pose2D WP1 = new SparkFunOTOS.Pose2D(-27.6,0,0);
